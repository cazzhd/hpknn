<p align="center">
	<img width="100px" src="https://efficomp.ugr.es/wp-content/uploads/2021/03/efficomp_logo1.svg" align="center" alt="Efficomp" />
...
Hpknn requires a GCC compiler and OpenCL 1.2 compliant CPU-GPU devices. It also depends on the following APIs and libraries:

* [OpenMPI](https://www.open-mpi.org/doc/current/)
* [OpenMP](https://www.doxygen.nl/index.html)
* [CUDA](http://developer.amd.com/wordpress/media/2012/10/AMD_APP_SDK_Release_Notes_Developer2.pdf)
* [Doxygen](https://www.doxygen.nl/index.html) if you want to generate documentation.

## Documentation

Hpknn is fully documented in its [Github Pages](https://cazzhd.github.io/hpknn/). In addition, the `Makefile` file contains a rule to generate [Doxygen](https://www.doxygen.nl/index.html) documentation in the `docs/html` folder.
...
Hpknn © 2021 [EFFICOMP](https://atcproyectos.ugr.es/efficomp/).
